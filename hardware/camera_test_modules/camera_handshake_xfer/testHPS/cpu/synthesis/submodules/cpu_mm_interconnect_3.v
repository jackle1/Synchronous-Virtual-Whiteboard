...
module cpu_mm_interconnect_3 (
	...
	cpu_mm_interconnect_3_router router (
	...
	cpu_mm_interconnect_3_router_001 router_001 (
	...
	cpu_mm_interconnect_3_router_001 router_002 (
	...
	cpu_mm_interconnect_3_cmd_demux cmd_demux (
		.clk                (sys_clk_sys_clk_clk),                                          //        clk.clk
		.reset              (master_0_master_translator_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	cpu_mm_interconnect_3_cmd_mux cmd_mux (
		.clk                 (sys_clk_sys_clk_clk),                                              //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_3_cmd_mux cmd_mux_001 (
		.clk                 (sys_clk_sys_clk_clk),                                              //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_3_rsp_demux rsp_demux (
		.clk                (sys_clk_sys_clk_clk),                                              //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_3_rsp_demux rsp_demux_001 (
		.clk                (sys_clk_sys_clk_clk),                                              //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_3_rsp_mux rsp_mux (
		.clk                 (sys_clk_sys_clk_clk),                                          //       clk.clk
		.reset               (master_0_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
