...
module cpu_mm_interconnect_0 (
	...
	wire  [19:0] wifi_uart_avalon_rs232_slave_agent_m0_address;                                      // wifi_uart_avalon_rs232_slave_agent:m0_address -> wifi_uart_avalon_rs232_slave_translator:uav_address
	...
	wire  [96:0] wifi_uart_avalon_rs232_slave_agent_rf_source_data;                                  // wifi_uart_avalon_rs232_slave_agent:rf_source_data -> wifi_uart_avalon_rs232_slave_agent_rsp_fifo:in_data
	...
	wire  [96:0] wifi_uart_avalon_rs232_slave_agent_rsp_fifo_out_data;                               // wifi_uart_avalon_rs232_slave_agent_rsp_fifo:out_data -> wifi_uart_avalon_rs232_slave_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> wifi_uart_avalon_rs232_slave_agent:cp_valid
	wire  [95:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> wifi_uart_avalon_rs232_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // wifi_uart_avalon_rs232_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> wifi_uart_avalon_rs232_slave_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> wifi_uart_avalon_rs232_slave_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> wifi_uart_avalon_rs232_slave_agent:cp_endofpacket
	...
	wire  [19:0] touchscreen_uart_avalon_rs232_slave_agent_m0_address;                               // touchscreen_uart_avalon_rs232_slave_agent:m0_address -> touchscreen_uart_avalon_rs232_slave_translator:uav_address
	...
	wire  [96:0] touchscreen_uart_avalon_rs232_slave_agent_rf_source_data;                           // touchscreen_uart_avalon_rs232_slave_agent:rf_source_data -> touchscreen_uart_avalon_rs232_slave_agent_rsp_fifo:in_data
	...
	wire  [96:0] touchscreen_uart_avalon_rs232_slave_agent_rsp_fifo_out_data;                        // touchscreen_uart_avalon_rs232_slave_agent_rsp_fifo:out_data -> touchscreen_uart_avalon_rs232_slave_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> touchscreen_uart_avalon_rs232_slave_agent:cp_valid
	wire  [95:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> touchscreen_uart_avalon_rs232_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // touchscreen_uart_avalon_rs232_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> touchscreen_uart_avalon_rs232_slave_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> touchscreen_uart_avalon_rs232_slave_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> touchscreen_uart_avalon_rs232_slave_agent:cp_endofpacket
	...
	wire  [19:0] leds_r_s1_agent_m0_address;                                                         // leds_r_s1_agent:m0_address -> leds_r_s1_translator:uav_address
	...
	wire  [96:0] leds_r_s1_agent_rf_source_data;                                                     // leds_r_s1_agent:rf_source_data -> leds_r_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] leds_r_s1_agent_rsp_fifo_out_data;                                                  // leds_r_s1_agent_rsp_fifo:out_data -> leds_r_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> leds_r_s1_agent:cp_valid
	wire  [95:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> leds_r_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // leds_r_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> leds_r_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> leds_r_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> leds_r_s1_agent:cp_endofpacket
	...
	wire         wifi_uart_avalon_rs232_slave_agent_rp_valid;                                        // wifi_uart_avalon_rs232_slave_agent:rp_valid -> router_003:sink_valid
	wire  [95:0] wifi_uart_avalon_rs232_slave_agent_rp_data;                                         // wifi_uart_avalon_rs232_slave_agent:rp_data -> router_003:sink_data
	wire         wifi_uart_avalon_rs232_slave_agent_rp_ready;                                        // router_003:sink_ready -> wifi_uart_avalon_rs232_slave_agent:rp_ready
	wire         wifi_uart_avalon_rs232_slave_agent_rp_startofpacket;                                // wifi_uart_avalon_rs232_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         wifi_uart_avalon_rs232_slave_agent_rp_endofpacket;                                  // wifi_uart_avalon_rs232_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [95:0] touchscreen_uart_avalon_rs232_slave_agent_rp_data;                                  // touchscreen_uart_avalon_rs232_slave_agent:rp_data -> router_004:sink_data
	...
	wire         leds_r_s1_agent_rp_valid;                                                           // leds_r_s1_agent:rp_valid -> router_007:sink_valid
	wire  [95:0] leds_r_s1_agent_rp_data;                                                            // leds_r_s1_agent:rp_data -> router_007:sink_data
	wire         leds_r_s1_agent_rp_ready;                                                           // router_007:sink_ready -> leds_r_s1_agent:rp_ready
	wire         leds_r_s1_agent_rp_startofpacket;                                                   // leds_r_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         leds_r_s1_agent_rp_endofpacket;                                                     // leds_r_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         wifi_uart_avalon_rs232_slave_agent_rdata_fifo_src_valid;                            // wifi_uart_avalon_rs232_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] wifi_uart_avalon_rs232_slave_agent_rdata_fifo_src_data;                             // wifi_uart_avalon_rs232_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         wifi_uart_avalon_rs232_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_001:in_0_ready -> wifi_uart_avalon_rs232_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> wifi_uart_avalon_rs232_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> wifi_uart_avalon_rs232_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                  // wifi_uart_avalon_rs232_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> wifi_uart_avalon_rs232_slave_agent:rdata_fifo_sink_error
	wire         touchscreen_uart_avalon_rs232_slave_agent_rdata_fifo_src_valid;                     // touchscreen_uart_avalon_rs232_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] touchscreen_uart_avalon_rs232_slave_agent_rdata_fifo_src_data;                      // touchscreen_uart_avalon_rs232_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         touchscreen_uart_avalon_rs232_slave_agent_rdata_fifo_src_ready;                     // avalon_st_adapter_002:in_0_ready -> touchscreen_uart_avalon_rs232_slave_agent:rdata_fifo_src_ready
	...
	wire         leds_r_s1_agent_rdata_fifo_src_valid;                                               // leds_r_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] leds_r_s1_agent_rdata_fifo_src_data;                                                // leds_r_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         leds_r_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_005:in_0_ready -> leds_r_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> leds_r_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> leds_r_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // leds_r_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> leds_r_s1_agent:rdata_fifo_sink_error
	...
	cpu_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
